...
const Nav = [
  {href:'#', class:'brand-link', text: "ServeData"},
    ...
    main ${_} ${"holyGrid"},
      ...
      section ${{class:'content'}} ${"content"},
        section ${{class:'banner'}} ${"section"},
          h1 ${"ServeData"}.
        .
        section ${{id:'how', class:'card-stack'}} ${"section"},
        ...
        section ${{class:'pricing'}} ${"section"},
          ...
          section ${{class:'card-stack'}} ${"section"},
            ...
            section ${{class:'block'}} ${"card"},
              ...
              p, 
                a ${{href:'mailto:bryan.guner@gmail.com?body=Hi%20Cris&subject=Whale'}} :text ${"Email"}.
              .
            .
            section ${{class:'block'}} ${"card"},
              h1 ${"API Key Usage"}.
          ...
          h1 ${"Frequently Asked Questions"}.
            section ${{class:'block'}} ${"card"},
              dl,
                ...
                dd,
                  :text ${"Please, "}.
                  a ${{href:'mailto:bryan.guner@gmail.com?body=Hi%20Cris&subject=BrowserGap%20Help'}} :text ${"mail me"}.
                  :text ${" for assistance."}.
                .
              .
            .
      ...
      footer ${_} ${"footer"},
        nav ul ${_} ${"responsiveList"},
          ...
          li a ${{href:'mailto:bryan.guner@gmail.com?body=Hi%20Cris&subject=Hello'}} :text ${"Email"}.
