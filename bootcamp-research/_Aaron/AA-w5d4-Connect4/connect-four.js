...
if (localStorage.getItem("data") !== null) {
  let loadedData = new GameJsonDeSerializer(
  ...
  if (!game) {
    ...
    for (let i = 0; i <= 6; i++) {
      if (game.isColumnFull(i)) {
        ...
        document.getElementById(`column-${i}`).setAttribute("disabled", "true");
      }
    }
...
//Click New Game
document.getElementById("new-game").addEventListener("click", (eve) => {
  // if (game === undefined) {
