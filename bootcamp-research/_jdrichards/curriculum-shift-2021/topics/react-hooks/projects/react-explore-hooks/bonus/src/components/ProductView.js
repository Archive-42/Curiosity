...
function ProductView() {
    ...
    // NOTE TO INSTRUCTORS: Because value was stored as string, it will be
    // "truthy" when "false" (as well as "true")
    ...
    useEffect(() => {
        ...
        // NOTE TO INSTRUCTORS: Storing as string makes it easier
        // to detect existence on refresh (see above)
        localStorage.setItem('productSidePanelOpen', sideOpen.toString())
    }, [sideOpen]);
