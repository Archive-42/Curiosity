...
for step in range(len(path1)):
  dir1 = path1[step][0:1]
  step1 = int(path1[step][1:])
  for move1 in range(1, step1 + 1):
    wire_steps_1 += 1
    if dir1 == 'R':
      pos1[1] += 1
    elif dir1 == 'L':
      ...
      pos1[0] -= 1
    visited1.append(pos1.copy())
    # if circuit[pos1[0]][pos1[1]][0] > wire_steps_1:
    #    circuit[pos1[0]][pos1[1]][0] = wire_steps_1

  dir2 = path2[step][0:1]
  step2 = int(path2[step][1:])
  for move2 in range(1, step2 + 1):
    wire_steps_2 += 1
    if dir2 == 'R':
      pos2[1] += 1
    elif dir2 == 'L':
      ...
      pos2[0] -= 1
    visited2.append(pos2.copy())
    # if circuit[pos1[0]][pos1[1]][1] > wire_steps_2:
    #    circuit[pos1[0]][pos1[1]][1] = wire_steps_2

print(len(visited1))
print(len(visited2))
shortest = float("inf")
for steps1 in range(1, len(visited1)):
  for steps2 in range(1, len(visited2)):
    if steps1 + steps2 > shortest:
      break
    if visited1[steps1] == visited2[steps2] and steps1 + steps2 < shortest:
      shortest = steps1 + steps2
      print(shortest)
print("Final: " + str(shortest))
