...
export const champRef = {
  ...
  TFT4_Ahri: { name: "Ahri", cost: 4, traits: ["Set4_Spirit", "Set4_Mage"] },
  TFT4_Akali: {
    name: "Akali",
    cost: 3,
  ...
  TFT4_Aphelios: { name: "Aphelios", cost: 2, traits: ["Moonlight", "Hunter"] },
  TFT4_Ashe: { name: "Ashe", cost: 4, traits: ["Set4_Elderwood", "Hunter"] },
  TFT4_Azir: {
    name: "Azir",
    cost: 5,
  ...
  TFT4_Evelynn: { name: "Evelynn", cost: 3, traits: ["Cultist", "Set4_Shade"] },
  TFT4_Ezreal: {
    name: "Ezreal",
    cost: 5,
  ...
  TFT4_Jhin: { name: "Jhin", cost: 4, traits: ["Cultist", "Sharpshooter"] },
  TFT4_Jinx: { name: "Jinx", cost: 3, traits: ["Fortune", "Sharpshooter"] },
  ...
  TFT4_Kindred: { name: "Kindred", cost: 3, traits: ["Set4_Spirit", "Hunter"] },
  TFT4_LeeSin: { name: "Lee Sin", cost: 5, traits: ["Divine", "Duelist"] },
  TFT4_Lillia: { name: "Lillia", cost: 5, traits: ["Dusk", "Set4_Mage"] },
  TFT4_Lissandra: {
    name: "Lissandra",
    cost: 1,
  ...
  TFT4_Lux: { name: "Lux", cost: 3, traits: ["Divine", "Set4_Dazzler"] },
  TFT4_Maokai: {
    name: "Maokai",
    cost: 1,
  ...
  TFT4_Pyke: { name: "Pyke", cost: 2, traits: ["Cultist", "Set4_Assassin"] },
  TFT4_Riven: { name: "Riven", cost: 4, traits: ["Dusk", "Keeper"] },
  TFT4_Sejuani: {
    name: "Sejuani",
    cost: 4,
  ...
  TFT4_Sylas: { name: "Sylas", cost: 1, traits: ["Moonlight", "Set4_Brawler"] },
  TFT4_TahmKench: {
    name: "Tahm Kench",
    cost: 1,
  ...
  TFT4_Thresh: { name: "Thresh", cost: 2, traits: ["Dusk", "Set4_Vanguard"] },
  TFT4_TwistedFate: {
    name: "Twisted Fate",
    cost: 1,
    traits: ["Cultist", "Set4_Mage"],
  },
  TFT4_Vayne: { name: "Vayne", cost: 1, traits: ["Dusk", "Sharpshooter"] },
  TFT4_Veigar: {
    name: "Veigar",
    cost: 3,
  ...
  TFT4_XinZhao: { name: "Xin Zhao", cost: 3, traits: ["Warlord", "Duelist"] },
  ...
  TFT4_Zed: { name: "Zed", cost: 2, traits: ["Set4_Ninja", "Set4_Shade"] },
