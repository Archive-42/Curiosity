      ...
      <div className="UserTickets">
        ...
        {!!tickets.length ? (
              ...
              <li key={ticket.id}>
                <div className="ticket-card">
                  ...
                  <div className="ticket-card__details">
                    <h2 className="ticket-event-name">{ticket.Event.name}</h2>
                    ...
                    <div className="ticket-card__details__actions">
                      ...
                      {ticket.isDeleting ? (
                        ...
                        <button
                          onClick={() =>
                            dispatch(ticketActions.deleteTicket(ticket.id))
                          }
          ...
          <>
            <p>No tickets, yet</p>
            <p>
              Register for one from our <Link to="/events">events page</Link>!
            </p>
          </>
        )}
      </div>
