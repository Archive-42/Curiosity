...
const toString = (head) => {
  ...
  for (let i = head; i; i = i.next) {
    arr.push(
      `${i.value}(${(i.previous && i.previous.value) || ""},${
        (i.child && i.child.value) || ""
      })`
    );
  }
  return `{ ${arr.join(" -> ")} }`;
...
[flatten, flattenBrute].forEach((fn) => {
  describe(`flatten: ${fn.name}`, () => {
    ...
    it("works with flat 2 levels", () => {
      ...
      expect(toString(fn(l3[0]))).toEqual(
        "{ 21(,) -> 23(21,) -> 36(23,) -> 37(36,) }"
      );
    });
    ...
    it("works with flat 2 levels and reminder", () => {
      ...
      expect(toString(fn(l1[0]))).toEqual(
        "{ 1(,) -> 2(1,) -> 36(2,) -> 37(36,) -> 3(37,) }"
      );
    });
    ...
    it("should flatten 3 levels", () => {
      ...
      expect(toString(l2[0])).toEqual(
        "{ 10(,) -> 12(10,21) -> 14(12,36) -> 16(14,) }"
      );

      // run
      expect(toString(fn(l1[0]))).toEqual(
        "{ 1(,) -> 2(1,) -> 10(2,) -> 12(10,) -> 21(12,) -> 23(21,) -> 14(23,) -> 36(14,) -> 37(36,) -> 16(37,) -> 3(16,) }"
      );
    });
  });
});
