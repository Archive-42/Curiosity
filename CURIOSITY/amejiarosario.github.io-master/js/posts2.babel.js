    ...
    var ScrollSpy = /*#__PURE__*/ (function () {
      function ScrollSpy() {
        var _ref =
          ...
          activeClass =
            _ref$activeClass === void 0 ? "active" : _ref$activeClass,
          _ref$tocLevelPrefixCl = _ref.tocLevelPrefixClass,
          tocLevelPrefixClass =
            _ref$tocLevelPrefixCl === void 0
              ? ".toc-level-"
              : _ref$tocLevelPrefixCl,
          ...
          value: function getTocItems() {
            ...
            var traverseTree = function traverseTree(el) {
              ...
              return Array.from(
                (el === null || el === void 0
                  ? void 0
                  : (_el$children$ = el.children[1]) === null ||
                    _el$children$ === void 0
                  ? void 0
            ...
            this.tocTree = Array.from(
              document.querySelectorAll(".toc > .toc-item")
            )
              .map(function (item) {
                return {
                  item: item,
