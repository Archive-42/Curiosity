# Refactor to Function Components Using Hooks

> WARNING: WORK IN PROGRESS!

...

... The following is backwards because it came from an intro to hook after 
class components. It seems like the examples could be reversed to teach the
refactoring process. ...
