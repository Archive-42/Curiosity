...
var GiphysIndex = function GiphysIndex(_ref) {
  ...
  var giphyItems = giphys.map(function (giphy) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, giphyItems);
};
...
/* harmony default export */ __webpack_exports__["default"] = (GiphyIndexItem);
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  var res = $.ajax({
    method: 'GET',
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=J51nVm6cFhHNmfrt9tuwclgXaI5g7Ru6\n&limit=2")
  }); // debugger
