...
function genFastGnpRandomGraph(n, p, optDirected) {
  return (0, _internalsDelegate2["default"])("fastGnpRandomGraph", [
    n,
    p,
    optDirected,
  ]);
...
function gnpRandomGraph(n, p) {
  ...
  var G = optDirected
    ? new _classesDiGraph2["default"]()
    : new _classesGraph2["default"]();
  var edges;
  ...
  edges = G.isDirected()
    ? (0, _internals.genPermutations)(rangeN, 2)
    : (0, _internals.genCombinations)(rangeN, 2);
  ...
  try {
    for (
      var _iterator = _getIterator(edges), _step;
...
function genGnpRandomGraph(n, p, optDirected) {
  return (0, _internalsDelegate2["default"])("gnpRandomGraph", [
    n,
    p,
    optDirected,
  ]);
...
function genBinomialGraph(n, p, optDirected) {
  return (0, _internalsDelegate2["default"])("binomialGraph", [
    n,
    p,
    optDirected,
  ]);
...
function genErdosRenyiGraph(n, p, optDirected) {
  return (0, _internalsDelegate2["default"])("erdosRenyiGraph", [
    n,
    p,
    optDirected,
  ]);
