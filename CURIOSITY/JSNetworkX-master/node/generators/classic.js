...
function treeEdges(n, r) {
  ...
  return _regeneratorRuntime.wrap(
    function treeEdges$(context$1$0) {
      while (1)
...
function completeGraph(n, optCreateUsing) {
  ...
  if (n > 1) {
    G.addEdgesFrom(
      G.isDirected()
        ? (0, _internals.genPermutations)((0, _internals.range)(n), 2)
        : (0, _internals.genCombinations)((0, _internals.range)(n), 2)
    );
  }
  return G;
}
...
function pathGraph(n, optCreateUsing) {
  ...
  G.name = "pathGraph(" + n + ")";
  G.addEdgesFrom(
    (0, _internals.mapIterator)((0, _internals.genRange)(n - 1), function (v) {
