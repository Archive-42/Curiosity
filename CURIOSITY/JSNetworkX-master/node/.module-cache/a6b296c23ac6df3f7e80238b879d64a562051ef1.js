  ...
  if (source == null) {
    if (target == null) {
      ...
      try {
        ...
        if (weight == null) {
          ...
          paths = (0, _weighted.singleSourceDijkstraPath)(G, {
            target: target,
            weight: weight,
          });
        }
        ...
        try {
          for (
            var _iterator = _getIterator(paths), _step;
    ...
    if (target == null) {
      ...
      if (weight == null) {
        ...
        paths = (0, _weighted.dijkstraPath)(G, {
          source: source,
          target: target,
          weight: weight,
        });
...
function genShortestPath(G, _source$target$weight) {
  return (0, _internalsDelegate2["default"])("shortestPath", [
    G,
  ...
  if (source == null) {
    if (target == null) {
      ...
      if (weight == null) {
        ...
        paths = (0, _weighted.allPairsDijkstraPathLength)(G, {
          weight: weight,
        });
      }
    } else {
      ...
      try {
        ...
        if (weight == null) {
          ...
          paths = (0, _weighted.singleSourceDijkstraPathLength)(G, {
            target: target,
            weight: weight,
          });
        }
    ...
    if (target == null) {
      ...
      if (weight == null) {
        ...
        paths = (0, _weighted.dijkstraPathLength)(G, {
          source: source,
          target: target,
          weight: weight,
        });
...
function genShortestPathLength(G, _source$target$weight2) {
  return (0, _internalsDelegate2["default"])("shortestPathLength", [
    G,
