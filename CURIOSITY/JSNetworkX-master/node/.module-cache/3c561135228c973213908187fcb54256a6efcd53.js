...
function betweennessCentrality(G) {
  ...
  var v;
  var betweenness = new _internals.Map(
...
function genBetweennessCentrality(G, optArgDict) {
  return (0, _internalsDelegate2["default"])("betweennessCentrality", [
    G,
    optArgDict,
  ]);
}
...
function edgeBetweennessCentrality(G) {
  ...
  try {
    for (
      var _iterator3 = _getIterator(G.edgesIter()), _step3;
  ...
  try {
    for (
      var _iterator5 = _getIterator(G), _step5;
...
function genEdgeBetweennessCentrality(G, optArgDict) {
  return (0, _internalsDelegate2["default"])("edgeBetweennessCentrality", [
    G,
    optArgDict,
  ]);
}
...
function singleSourceDijkstraPathBasic(G, s) {
  ...
  while (Q.size > 0) {
    ...
    try {
      for (
        var _iterator10 = _getIterator(G.get(v)), _step10;
