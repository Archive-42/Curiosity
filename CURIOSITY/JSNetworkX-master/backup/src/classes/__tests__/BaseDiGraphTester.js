...
export default _.extend({}, BaseGraphTester, {
  ...
  testEdgesIter: function () {
    var G = this.K3;
    assert.deepEqual(Array.from(G.edgesIter()), [
      [0, 1],
      [0, 2],
      [1, 0],
      [1, 2],
    ...
    assert.deepEqual(Array.from(G.edgesIter(0)), [
      [0, 1],
      [0, 2],
    ]);
  },
  ...
  testOutEdgesIter: function () {
    var G = this.K3;
    assert.deepEqual(Array.from(G.outEdgesIter()), [
      [0, 1],
      [0, 2],
      [1, 0],
      [1, 2],
    ...
    assert.deepEqual(Array.from(G.outEdgesIter(0)), [
      [0, 1],
      [0, 2],
    ]);
  },
  ...
  testInEdgesIterDir: function () {
    var G = this.P3;
    assert.deepEqual(Array.from(G.inEdgesIter()), [
      [0, 1],
      [1, 2],
    ]);
  ...
  testDegreeIter: function () {
    var G = this.K3;
    assert.deepEqual(Array.from(G.degreeIter()), [
      [0, 4],
      [1, 4],
      [2, 4],
    ]);
  ...
  testInDegreeIter: function () {
    var G = this.K3;
    assert.deepEqual(Array.from(G.inDegreeIter()), [
      [0, 2],
      [1, 2],
      [2, 2],
    ]);
  ...
  testInDegreeIterWeighted: function () {
    ...
    assert.deepEqual(Array.from(G.inDegreeIter(null, "weight")), [
      [0, 2],
      [1, 1.3],
      [2, 2],
    ]);
    ...
    assert.deepEqual(Array.from(G.inDegreeIter(null, "other")), [
      [0, 2],
      [1, 2.2],
      [2, 2],
    ]);
  ...
  testOutDegreeIter: function () {
    var G = this.K3;
    assert.deepEqual(Array.from(G.outDegreeIter()), [
      [0, 2],
      [1, 2],
      [2, 2],
    ]);
  ...
  testOutDegreeIterWeighted: function () {
    var G = this.K3;
    G.addEdge(0, 1, { weight: 0.3, other: 1.2 });
    assert.deepEqual(Array.from(G.outDegreeIter(null, "weight")), [
      [0, 1.3],
      [1, 2],
      [2, 2],
    ]);
    ...
    assert.deepEqual(Array.from(G.outDegreeIter(null, "other")), [
      [0, 2.2],
      [1, 2],
      [2, 2],
    ]);
