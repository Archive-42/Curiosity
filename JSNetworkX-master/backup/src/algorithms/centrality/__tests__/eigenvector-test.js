...
import { DiGraph, MultiGraph } from "../../../classes";

import { completeGraph, pathGraph } from "../../../generators";
...
export var testEigenvectorCentrality = {
  ...
  */
  ...
  testMaxIter() {
    assert.throws(() => eigenvectorCentrality(pathGraph(3), { maxIter: 0 }));
  },
};
...
export var testEigenvectorCentralityExceptions = {
  testMultigraph() {
    assert.throws(() => eigenvectorCentrality(new MultiGraph()));
  },

  testEmpty() {
    assert.throws(() => eigenvectorCentrality(new DiGraph()));
  },
};
