...
var _exceptionsJSNetworkXNoPath2 = _interopRequireDefault(
  _exceptionsJSNetworkXNoPath
);
...
function dijkstraPath(G, _ref3) {
  ...
  var _singleSourceDijkstra = singleSourceDijkstra(G, {
  ...
  if (!path) {
    throw new _exceptionsJSNetworkXNoPath2["default"](
...
function genDijkstraPath(G, _source$target$weight) {
  return (0, _internalsDelegate2["default"])("dijkstraPath", [
    G,
    _source$target$weight,
  ]);
}
...
function dijkstraPathLength(G, _ref4) {
  ...
  var distances = singleSourceDijkstraPathLength(G, {
    source: source,
    weight: weight,
  });
...
function genDijkstraPathLength(G, _source$target$weight2) {
  return (0, _internalsDelegate2["default"])("dijkstraPathLength", [
    G,
    _source$target$weight2,
  ]);
}
...
function singleSourceDijkstraPath(G, _ref5) {
  ...
  var _singleSourceDijkstra3 = singleSourceDijkstra(G, {
    // eslint-disable-line no-unused-vars
    source: source,
    cutoff: cutoff,
    weight: weight,
...
function genSingleSourceDijkstraPath(G, _source$cutoff$weight) {
  return (0, _internalsDelegate2["default"])("singleSourceDijkstraPath", [
    G,
    _source$cutoff$weight,
  ]);
}
...
function singleSourceDijkstraPathLength(G, _ref6) {
  ...
  while (fringe.size > 0) {
    ...
    try {
      for (
        var _iterator = _getIterator(edata), _step;
...
function genSingleSourceDijkstraPathLength(G, _source$cutoff$weight2) {
  return (0, _internalsDelegate2["default"])("singleSourceDijkstraPathLength", [
    G,
    _source$cutoff$weight2,
  ]);
}
...
function singleSourceDijkstra(G, _ref8) {
  ...
  if ((0, _internals.nodesAreEqual)(source, target)) {
    return [
      new _internals.Map([[source, 0]]),
      new _internals.Map([[source, target]]),
    ];
  }
  ...
  while (fringe.size > 0) {
    ...
    try {
      for (
        var _iterator2 = _getIterator(edata), _step2;
...
function genSingleSourceDijkstra(G, _source$target$cutoff$weight) {
  return (0, _internalsDelegate2["default"])("singleSourceDijkstra", [
    G,
    _source$target$cutoff$weight,
  ]);
}
...
function genAllPairsDijkstraPathLength(G, _cutoff$weight) {
  return (0, _internalsDelegate2["default"])("allPairsDijkstraPathLength", [
    G,
    _cutoff$weight,
  ]);
}
...
function allPairsDijkstraPath(G) {
  ...
  try {
    for (
      var _iterator4 = _getIterator(G), _step4;
...
function genAllPairsDijkstraPath(G, _cutoff$weight2) {
  return (0, _internalsDelegate2["default"])("allPairsDijkstraPath", [
    G,
    _cutoff$weight2,
  ]);
}
