...
exports.genIsValidDegreeSequenceHavelHakimi =
  genIsValidDegreeSequenceHavelHakimi;
exports.isValidDegreeSequenceErdosGallai = isValidDegreeSequenceErdosGallai;
exports.genIsValidDegreeSequenceErdosGallai =
  genIsValidDegreeSequenceErdosGallai;
...
function isGraphical(sequence) {
  var optMethod =
    arguments.length <= 1 || arguments[1] === undefined ? "hh" : arguments[1];
  ...
  switch (optMethod) {
    ...
    default:
      throw new _exceptions.JSNetworkXException(
...
function genIsGraphical(sequence, optMethod) {
  return (0, _internalsDelegate2["default"])("isGraphical", [
    sequence,
    optMethod,
  ]);
}
...
function genIsValidDegreeSequence(sequence, optMethod) {
  return (0, _internalsDelegate2["default"])("isValidDegreeSequence", [
    sequence,
    optMethod,
  ]);
}
...
function genIsValidDegreeSequenceHavelHakimi(degreeSequence) {
  return (0, _internalsDelegate2["default"])(
