...
var marked0$0 = [findCliques, findCliquesRecursive].map(
...
function findCliques(G) {
  ...
  return _regeneratorRuntime.wrap(
    function findCliques$(context$1$0) {
      while (1)
        switch ((context$1$0.prev = context$1$0.next)) {
          ...
          case 2:
            adj = new _internals.Map(
              (0, _internals.mapIterator)(G, function (u) {
...
function findCliquesRecursive(G) {
  ...
  return _regeneratorRuntime.wrap(
    function findCliquesRecursive$(context$1$0) {
      while (1)
        switch ((context$1$0.prev = context$1$0.next)) {
          case 0:
                  ...
                  while (1)
                    switch ((context$2$0.prev = context$2$0.next)) {
                      case 0:
                        ...
                        context$2$0.prev = 4;
                        _iterator = _getIterator(
                          candidates.difference(adj.get(u))
                        );
          ...
          case 5:
            ...
            return context$1$0.delegateYield(
              expand(new _internals.Set(G), new _internals.Set(G)),
              "t0",
              8
            );
...
function genGraphCliqueNumber(G, optCliques) {
  return (0, _internalsDelegate2["default"])("graphCliqueNumber", [
    G,
    optCliques,
  ]);
}
...
function genGraphNumberOfCliques(G, optCliques) {
  return (0, _internalsDelegate2["default"])("graphNumberOfCliques", [
    G,
    optCliques,
  ]);
}
...
function genNumberOfCliques(G, optNodes, optCliques) {
  return (0, _internalsDelegate2["default"])("numberOfCliques", [
    G,
    optNodes,
    optCliques,
  ]);
