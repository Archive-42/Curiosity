...
function delegateToChildProcess(method, args) {
  return new _Promise(function (resolve, reject) {
    var response = "";
    var error = "";
    var child = _child_process2["default"].spawn(process.execPath, [
      _path2["default"].join(__dirname, "../worker.js"),
    ]);
...
function delegate(method, args) {
  ...
  return delegateToChildProcess(method, serializedValues).then(function (
    response
  ) {
